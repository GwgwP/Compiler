...
public interface Analysis extends Switch
{
    ...
    void caseAAsExpression(AAsExpression node);
    void caseADewExpressiono(ADewExpressiono node);
    void caseAPinakasexpExpressiono(APinakasexpExpressiono node);
    void caseARedExpressiono(ARedExpressiono node);
    void caseAMaxExExpressiono(AMaxExExpressiono node);
    void caseAMinExExpressiono(AMinExExpressiono node);
    ...
    void caseAMsaFactor(AMsaFactor node);
    void caseAAdFactor(AAdFactor node);
    void caseAAsFactor(AAsFactor node);
    ...
    void caseAGiiagigaValue(AGiiagigaValue node);
