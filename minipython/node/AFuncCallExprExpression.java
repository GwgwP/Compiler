...
public final class AFuncCallExprExpression extends PExpression
{
    private PFunctionCall _functionCall_;

    public AFuncCallExprExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AFuncCallExprExpression(
            (PFunctionCall) cloneNode(_functionCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFuncCallExprExpression(this);
    }
