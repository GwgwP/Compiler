...
public final class ADefinitionFunction extends PFunction
{
    private TDef _def_;
    private TId _id_;
    ...
    public Object clone()
    {
        return new ADefinitionFunction(
    ...
    {
        ((Analysis) sw).caseADefinitionFunction(this);
    }
