...
public final class AAdditionExCalculation extends PCalculation
{
    private PExpression _expression_;
    private TPlus _plus_;
    private PExpressionsWithoutCulc _expressionsWithoutCulc_;

    public AAdditionExCalculation()
    {
    }
    ...
    public Object clone()
    {
        return new AAdditionExCalculation(
    ...
    {
        ((Analysis) sw).caseAAdditionExCalculation(this);
    }
