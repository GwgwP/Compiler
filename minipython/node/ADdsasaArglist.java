...
public final class ADdsasaArglist extends PArglist
{
    ...
    {
        ((Analysis) sw).caseADdsasaArglist(this);
    }
    ...
    private class CommaExpression_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != ADdsasaArglist.this))
            {
                node.parent().removeChild(node);
            }
