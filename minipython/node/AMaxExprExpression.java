...
public final class AMaxExprExpression extends PExpression
{
    private PExpression _l_;
    private final LinkedList _r_ = new TypedLinkedList(new R_Cast());

    public AMaxExprExpression()
    {
    }
    ...
    {
        ((Analysis) sw).caseAMaxExprExpression(this);
    }
    ...
    private class R_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AMaxExprExpression.this))
            {
                node.parent().removeChild(node);
            }
