...
public final class ABracketsExprValueExpression extends PExpression
{
    private PExpression _l_;
    private final LinkedList _r_ = new TypedLinkedList(new R_Cast());

    public ABracketsExprValueExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ABracketsExprValueExpression(
    ...
    {
        ((Analysis) sw).caseABracketsExprValueExpression(this);
    }
    ...
    private class R_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != ABracketsExprValueExpression.this))
            {
                node.parent().removeChild(node);
            }
