...
public final class ABracketsExprValueValue extends PValue
{
    private TLBr _lBr_;
    ...
    public ABracketsExprValueValue()
    {
    }
    ...
    public Object clone()
    {
        return new ABracketsExprValueValue(
    ...
    {
        ((Analysis) sw).caseABracketsExprValueValue(this);
    }
    ...
    private class CommaExpression_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != ABracketsExprValueValue.this))
            {
                node.parent().removeChild(node);
            }
