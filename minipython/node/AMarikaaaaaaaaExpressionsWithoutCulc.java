...
public final class AMarikaaaaaaaaExpressionsWithoutCulc extends PExpressionsWithoutCulc
{
    private TLBr _lBr_;
    ...
    public AMarikaaaaaaaaExpressionsWithoutCulc()
    {
    }
    ...
    public Object clone()
    {
        return new AMarikaaaaaaaaExpressionsWithoutCulc(
    ...
    {
        ((Analysis) sw).caseAMarikaaaaaaaaExpressionsWithoutCulc(this);
    }
    ...
    private class CommaExpression_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AMarikaaaaaaaaExpressionsWithoutCulc.this))
            {
                node.parent().removeChild(node);
            }
