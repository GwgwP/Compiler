...
public final class AIdPluseqStatementStatement extends PStatement
{
    ...
    public AIdPluseqStatementStatement()
    {
    }
    ...
    public Object clone()
    {
        return new AIdPluseqStatementStatement(
            cloneList(_tab_),
            (TId) cloneNode(_id_),
    ...
    {
        ((Analysis) sw).caseAIdPluseqStatementStatement(this);
    }
    ...
    private class Tab_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AIdPluseqStatementStatement.this))
            {
                node.parent().removeChild(node);
            }
