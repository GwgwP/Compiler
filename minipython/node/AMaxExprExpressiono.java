...
public final class AMaxExprExpressiono extends PExpressiono
{
    private TMax _max_;
    ...
    public Object clone()
    {
        return new AMaxExprExpressiono(
    ...
    {
        ((Analysis) sw).caseAMaxExprExpressiono(this);
    }
    ...
    private class CommaValue_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AMaxExprExpressiono.this))
            {
                node.parent().removeChild(node);
            }
