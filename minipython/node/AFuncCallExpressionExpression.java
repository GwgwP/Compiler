...
public final class AFuncCallExpressionExpression extends PExpression
{
    private PFunctionCall _functionCall_;

    public AFuncCallExpressionExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AFuncCallExpressionExpression(
            (PFunctionCall) cloneNode(_functionCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFuncCallExpressionExpression(this);
    }
