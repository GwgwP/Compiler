...
public final class AFuncCallStatementStatement extends PStatement
{
    private final LinkedList _tab_ = new TypedLinkedList(new Tab_Cast());
    private PFunctionCall _functionCall_;

    public AFuncCallStatementStatement()
    {
    }
    ...
    public Object clone()
    {
        return new AFuncCallStatementStatement(
            cloneList(_tab_),
    ...
    {
        ((Analysis) sw).caseAFuncCallStatementStatement(this);
    }
    ...
    private class Tab_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AFuncCallStatementStatement.this))
            {
                node.parent().removeChild(node);
            }
