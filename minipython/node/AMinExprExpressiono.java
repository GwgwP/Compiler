...
public final class AMinExprExpressiono extends PExpressiono
{
    private TMin _min_;
    ...
    public Object clone()
    {
        return new AMinExprExpressiono(
    ...
    {
        ((Analysis) sw).caseAMinExprExpressiono(this);
    }
    ...
    private class CommaValue_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AMinExprExpressiono.this))
            {
                node.parent().removeChild(node);
            }
