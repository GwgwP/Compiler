...
public final class AGreatcComparisons extends PComparisons
{
    private PExpression _lpar_;
    private PExpression _rpar_;

    public AGreatcComparisons()
    {
    }
    ...
    {
        ((Analysis) sw).caseAGreatcComparisons(this);
    }
